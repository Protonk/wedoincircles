...
| File | Produces |
|---|---|
| `n-gons/anchor_345.sage` | `figures/anchor_345.png` |
| `corners/pseudo_chebyshev_arithmetic_ladder.sage` | `figures/pseudo_chebyshev_arithmetic_ladder.png` |
| `corners/pseudo_chebyshev_continuity.sage` | `figures/pseudo_chebyshev_continuity.png` |
