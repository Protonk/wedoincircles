...
![Three stacked panels sharing a horizontal polygon-order axis from n=5 to 9, with pink vertical bands and bold red ticks marking n=7 and n=9. Top panel "node side: tower depth if constructible": green filled circles labeled "depth 1" at n=5,6 and "depth 2" at n=8, plus red triangles labeled ∞ rising into the pink bands at n=7 and n=9. Middle panel "trace side": blue stem-and-disk markers reaching heights 2, 1, 3, 2, 3 across the row. Bottom panel "counting apparatus": orange bars of heights 5, 6, 9, 11, 15 with a magenta step-line above them tagged +2, +1, +3, +2, +4 against a secondary axis on the right.](../figures/case_seven_three_costs.png)
