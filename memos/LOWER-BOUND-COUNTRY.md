...
- `rotations/CONTINUED-FRACTIONS-CROSSWALK.md` — continued fractions as description-length substrate across spectral, 3DT, computational, Beck, and K-H-L-A readings.
