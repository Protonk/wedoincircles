...
This is the PERMEATE leg. The exact arithmetic objects belong in `triad/plus_ultra/PERMEATE-THE-CIRCLE.md` and the crystallographic source brief. At the abstract level, Leg 2 tests whether a matching rule survives saturation, where the decisive datum is often the first witness at which the pattern breaks.
...
This is the BIND leg. The actual objects and obstructions belong in `triad/plus_ultra/BIND-THE-CIRCLE.md`. At the abstract level, Leg 3 tests whether any correspondence remains once the shared vocabulary is withheld and only native primitives are allowed.
...
| Leg 1 home | `triad/plus_ultra/CREATI-THE-CIRCLE.md` |
| Leg 2 home | `triad/plus_ultra/PERMEATE-THE-CIRCLE.md` |
| Leg 3 home | `triad/plus_ultra/BIND-THE-CIRCLE.md` |
