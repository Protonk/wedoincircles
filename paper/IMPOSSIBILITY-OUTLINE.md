...
| 8 | `β(π) = 0` L-W audit | §5.1 | Parallel-reading; conditional | If load-bearing in Lemma A's first bullet, audit under `memos/OLD-TIME-RELIGION.md` | Do not treat `β(π) = 0` as L-W-safe until provenance is audited. |
